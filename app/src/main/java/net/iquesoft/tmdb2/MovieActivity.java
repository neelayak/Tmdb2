...
public class MovieActivity extends AppCompatActivity {
    ...
    private TextView Revenue,Budget;
    private TextView movieReleaseDate;
    private RatingBar movieRating;
    private LinearLayout movieTrailers;
    private LinearLayout movieReviews;
    private TextView trailersLabel;
    private TextView reviewsLabel, movieDetailsrating;
    private TextView movieDetailsDuration;
    ...
    private void initUI() {
        ...
        movieDetailsrating = findViewById(R.id.movieDetailsrating);
        movieDetailsDuration = findViewById(R.id.movieDetailsDuration);
    ...
    private void getMovie() {
        moviesRepository.getMovie(movieId, new OnGetMovieCallback() {
            ...
            public void onSuccess(Movie movie) {
                ...
                movieDetailsDuration.setText(movie.getRuntime());
                movieDetailsrating.setText(String.valueOf(movie.getRating()));
